...
const songs = [
    ...
    {
        id: 5,
        songName: `Ertugural gazi<br>
        <div class="subtitle">Ertugural</div>`,
        poster: "img/5.jpg",
    },
    {
        id: 6,
    ...
    },
    {
        ...
        <div class="subtitle">neha kekkar</div>`,
        poster: "img/8.jpg",
    },
    {
        id: 9,
    ...
    },
    {
        id: 14,
        songName: `vaaste <br>
        <div class="subtitle">dhavani bhushali</div>`,
        poster: "img/14.jpg",
    },
    {
        id: 15,
    ...
    },
    {
        id: 16,
        songName: `tu meri <br>
        <div class="subtitle">tu meri zindhagi</div>`,
        poster: "img/16.jpg",
    },
    {
        id: 17,
        songName: `batao yad me<br>
        <div class="subtitle">mere dol</div>`,
        poster: "img/17.jpg",
    },
    {
        id: 18,
        songName: `mere dol  <br>
        <div class="subtitle">18</div>`,
        poster: "img/18.jpg",
    },
    {
        id: "19",
        songName: `eh munde paagal ne<br>
        <div class="subtitle">jhekie</div>`,
        poster: "img/19.jpg",
    },
    {
        id: 20,
...
Array.from(document.getElementsByClassName('listPlay')).forEach((value) => {
    value.addEventListener('click', (el) => {
        ...
        masterPlay.classList.add("fa-circle-pause");
        // for download
        download_btn.href = `audio/${index}.mp3`;
        // changing posters
