...
const music = new Audio('audio/rahaman/1.mp3');
...
const songs = [
    {
        ...
        poster: "img/rahaman/1.jpg",
    },
    {
        id: 2,
        songName: `Ale Ale<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/2.jpg",
    },
    {
        id: 3,
        songName: `boom boom<br>
        <div class="subtitle">A R Rahaman </div>`,
        poster: "img/rahaman/3.jpg",
    },
    {
        id: 4,
        songName: `Break the rules<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/4.jpg",
    },
    {
        id: 5,
        songName: `dating<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/5.jpg",
    },
    {
        id: 6,
        songName: `girlfriend<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/6.jpg",
    },
    {
        id: 7,
        songName: `Kaalam<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/7.jpg",
    },
    {
        id: 8,
        songName: `Mei Nigara<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/8.jpg",
    },
    {
        id: 9,
        songName: `My twin brother<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/9.jpg",
    },
    {
        id: 10,
        songName: `Naan un <br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/10.jpg",
    },
    {
        id: 11,
        songName: ` please sir<br>
        <div class="subtitle">A R Rahaman </div>`,
        poster: "img/rahaman/11.jpg",
    },
    {
        id: 12,
        songName: `Punnagaiye<br>
        <div class="subtitle">A R Rahaman</div>`,
        poster: "img/rahaman/12.jpg",
    },
    {
        id: 13,
        songName: `Secret of sucess<br>
        <div class="subtitle">A R Rahaman </div>`,
        poster: "img/rahaman/13.jpg",
    }
]
...
Array.from(document.getElementsByClassName('listPlay')).forEach((value) => {
    value.addEventListener('click', (el) => {
        index = el.target.id
        // console.log(index);
        music.src = `audio/rahaman/${index}.mp3`
        music.play();
        ...
        masterPlay.classList.add("fa-circle-pause");
        // for download
        download_btn.href = `audio/rahaman/${index}.mp3`;
        // changing posters
        posterImgDownBar.src = `img/rahaman/${index}.jpg`;
        // songTitles
